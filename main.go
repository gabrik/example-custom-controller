...
import (
	...
	fduclientset "github.com/gabrik/example-custom-controller/pkg/client/clientset/versioned"
	fduinformer_v1 "github.com/trstringer/example-custom-controller/pkg/client/informers/externalversions/fdu/v1"
)
...
func main() {
	...
	informer := fduinformer_v1.NewMyResourceInformer(
		fduClient,
